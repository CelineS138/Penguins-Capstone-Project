...
```{r}
playmaker <- complete_df_sel |> select(Player, PlayerID, starts_with("TOI_"), starts_with("A_"), contains("EVA_"), contains("PPA_"), contains("SHA_"))
...
playmaker <- playmaker |> 
  ungroup() |> 
  mutate(mean_EVA_23 = mean(`EVA/60_2023`),
         mean_EVA_22 = mean(`EVA/60_2022`),
         mean_EVA_21 = mean(`EVA/60_2021`),
         mean_EVA_20 = mean(`EVA/60_2020`),
         mean_EVA_19 = mean(`EVA/60_2019`),
         mean_EVA_18 = mean(`EVA/60_2018`),
         mean_EVA_17 = mean(`EVA/60_2017`),
         mean_EVA_16 = mean(`EVA/60_2016`),
         
         mean_PPA_23 = mean(`PPA/60_2023`),
         mean_PPA_22 = mean(`PPA/60_2022`),
         mean_PPA_21 = mean(`PPA/60_2021`),
         mean_PPA_20 = mean(`PPA/60_2020`),
         mean_PPA_19 = mean(`PPA/60_2019`),
         mean_PPA_18 = mean(`PPA/60_2018`),
         mean_PPA_17 = mean(`PPA/60_2017`),
         mean_PPA_16 = mean(`PPA/60_2016`),
         
         mean_SHA_23 = mean(`SHA/60_2023`),
         mean_SHA_22 = mean(`SHA/60_2022`),
         mean_SHA_21 = mean(`SHA/60_2021`),
         mean_SHA_20 = mean(`SHA/60_2020`),
         mean_SHA_19 = mean(`SHA/60_2019`),
         mean_SHA_18 = mean(`SHA/60_2018`),
         mean_SHA_17 = mean(`SHA/60_2017`),
         mean_SHA_16 = mean(`SHA/60_2016`),
         
         
         sd_EVA_23 = sd(`EVA/60_2023`),
         sd_EVA_22 = sd(`EVA/60_2022`),
         sd_EVA_21 = sd(`EVA/60_2021`),
         sd_EVA_20 = sd(`EVA/60_2020`),
         sd_EVA_19 = sd(`EVA/60_2019`),
         sd_EVA_18 = sd(`EVA/60_2018`),
         sd_EVA_17 = sd(`EVA/60_2017`),
         sd_EVA_16 = sd(`EVA/60_2016`),
         
         sd_PPA_23 = sd(`PPA/60_2023`),
         sd_PPA_22 = sd(`PPA/60_2022`),
         sd_PPA_21 = sd(`PPA/60_2021`),
         sd_PPA_20 = sd(`PPA/60_2020`),
         sd_PPA_19 = sd(`PPA/60_2019`),
         sd_PPA_18 = sd(`PPA/60_2018`),
         sd_PPA_17 = sd(`PPA/60_2017`),
         sd_PPA_16 = sd(`PPA/60_2016`),
         
         sd_SHA_23 = sd(`SHA/60_2023`),
         sd_SHA_22 = sd(`SHA/60_2022`),
         sd_SHA_21 = sd(`SHA/60_2021`),
         sd_SHA_20 = sd(`SHA/60_2020`),
         sd_SHA_19 = sd(`SHA/60_2019`),
         sd_SHA_18 = sd(`SHA/60_2018`),
         sd_SHA_17 = sd(`SHA/60_2017`),
         sd_SHA_16 = sd(`SHA/60_2016`),
         )
...
playmaker_score <- playmaker |> 
  group_by(Player, PlayerID) |> 
  summarise(
    EVA_z_score = (total_EVA_diff - mean_tot_EVA_diff) / sd_tot_EVA_diff,
    PPA_z_score = (total_PPA_diff - mean_tot_PPA_diff) / sd_tot_PPA_diff,
    SHA_z_score = (total_SHA_diff - mean_tot_SHA_diff) / sd_tot_SHA_diff
            )
```
...
```{r}
high_z_score <- playmaker_score |> 
  arrange(desc(EVA_z_score)) |> 
  head(10)

low_z_score <- playmaker_score |> 
  arrange(EVA_z_score) |> 
  head(10)

good_consistency <- playmaker_score |> 
  filter(EVA_z_score <= 0.1, EVA_z_score >= -0.1)
```
...
```{r}
high_z_score |> 
  ggplot(aes(EVA_z_score, reorder(Player, EVA_z_score))) +
  geom_col()
