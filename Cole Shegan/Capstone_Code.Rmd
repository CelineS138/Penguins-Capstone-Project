...
playmaker_score <- playmaker3 |> 
  group_by(Player, PlayerID) |> 
  summarise(
    EVA_zscore_23 = (`EVA/60_2023` - `mean_EVA_23`) / `sd_EVA_23`,
    EVA_zscore_22 = (`EVA/60_2022` - `mean_EVA_22`) / `sd_EVA_22`,
    EVA_zscore_21 = (`EVA/60_2021` - `mean_EVA_21`) / `sd_EVA_21`,
    EVA_zscore_20 = (`EVA/60_2020` - `mean_EVA_20`) / `sd_EVA_20`,
    EVA_zscore_19 = (`EVA/60_2019` - `mean_EVA_19`) / `sd_EVA_19`,
    EVA_zscore_18 = (`EVA/60_2018` - `mean_EVA_18`) / `sd_EVA_18`,
    EVA_zscore_17 = (`EVA/60_2017` - `mean_EVA_17`) / `sd_EVA_17`,
    EVA_zscore_16 = (`EVA/60_2016` - `mean_EVA_16`) / `sd_EVA_16`,
    ...
    SHA_zscore_23 = (`SHA/60_2023` - `mean_SHA_23`) / `sd_SHA_23`,
    SHA_zscore_22 = (`SHA/60_2022` - `mean_SHA_22`) / `sd_SHA_22`,
    SHA_zscore_21 = (`SHA/60_2021` - `mean_SHA_21`) / `sd_SHA_21`,
    SHA_zscore_20 = (`SHA/60_2020` - `mean_SHA_20`) / `sd_SHA_20`,
    SHA_zscore_19 = (`SHA/60_2019` - `mean_SHA_19`) / `sd_SHA_19`,
    SHA_zscore_18 = (`SHA/60_2018` - `mean_SHA_18`) / `sd_SHA_18`,
    SHA_zscore_17 = (`SHA/60_2017` - `mean_SHA_17`) / `sd_SHA_17`,
    SHA_zscore_16 = (`SHA/60_2016` - `mean_SHA_16`) / `sd_SHA_16`
            )
