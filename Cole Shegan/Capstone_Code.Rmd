...
master_energy2$consistent <- factor(master_energy2$consistent, levels = c('Bad Consistent', 'Ok Consistent', 'Good Consistent'))

master_energy2$skill <- factor(master_energy2$skill, levels = c('Worst', 'Bad', 'Good', 'Great'))
